...
const productSchema = Joi.object(
  {
    ...
    availableStatus: Joi.string().valid('in stock', 'low Stock', 'out of stock').empty("").allow(null).default('in stock'),
    productAge: Joi.string().valid('new', 'old').empty("").allow(null).default('new'),
