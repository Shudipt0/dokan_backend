...
const productSchema = Joi.object(
  {
    ...
    availableStatus: Joi.string().valid('in stock', 'low Stock', 'out of stock').custom((v) => (v === "" || v === null ? undefined : v)).default('in stock'),
    productAge: Joi.string().valid('new', 'old').custom((v) => (v === "" || v === null ? undefined : v)).default('new'),
